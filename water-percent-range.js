import { waterPercent_1 } from './script.js';
import { waterPercent_2 } from './script.js';
import { waterPercent_3 } from './script.js';
import { waterPercent_4 } from './script.js';
import { waterPercent_5 } from './script.js';
import { waterPercent_6 } from './script.js';
import { waterPercent_7 } from './script.js';
import { waterPercent_8 } from './script.js';
import { waterPercent_9 } from './script.js';
import { waterPercent_10 } from './script.js';
import { waterPercent_11 } from './script.js';
import { waterPercent_12 } from './script.js';
import { waterPercent_13 } from './script.js';
import { waterPercent_14 } from './script.js';
import { waterPercent_15 } from './script.js';
import { waterPercent_16 } from './script.js';
import { waterPercent_17 } from './script.js';
import { waterPercent_18 } from './script.js';
import { waterPercent_19 } from './script.js';
import { waterPercent_20 } from './script.js';
import { waterPercent_21 } from './script.js';
import { waterPercent_22 } from './script.js';
import { waterPercent_23 } from './script.js';
import { waterPercent_24 } from './script.js';

if (waterPercent_1.value >= 55 && waterPercent_1.value <= 65) {
  waterPercent_1.style.background = 'green';
} else if (waterPercent_1.value >= 65) {
...
} else if (waterPercent_2.value >= 65) {
...
} else if (waterPercent_3.value >= 65) {
...
} else if (waterPercent_4.value >= 65) {
...
} else if (waterPercent_5.value >= 65) {
...
} else if (waterPercent_6.value >= 65) {
...
} else if (waterPercent_7.value >= 65) {
...
} else if (waterPercent_8.value >= 65) {
...
} else if (waterPercent_9.value >= 65) {
...
} else if (waterPercent_11.value >= 65) {
...
} else if (waterPercent_12.value >= 65) {
...
} else if (waterPercent_13.value >= 65) {
...
} else if (waterPercent_14.value >= 65) {
...
} else if (waterPercent_15.value >= 65) {
...
} else if (waterPercent_16.value >= 65) {
...
} else if (waterPercent_17.value >= 65) {
...
} else if (waterPercent_18.value >= 65) {
...
} else if (waterPercent_19.value >= 65) {
...
} else if (waterPercent_20.value >= 65) {
...
} else if (waterPercent_21.value >= 65) {
...
} else if (waterPercent_22.value >= 65) {
...
} else if (waterPercent_23.value >= 65) {
...
} else if (waterPercent_24.value >= 65) {
