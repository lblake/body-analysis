import { totalBodyWater_1 } from './script.js';
import { totalBodyWater_2 } from './script.js';
import { totalBodyWater_3 } from './script.js';
import { totalBodyWater_4 } from './script.js';
import { totalBodyWater_5 } from './script.js';
import { totalBodyWater_6 } from './script.js';
import { totalBodyWater_7 } from './script.js';
import { totalBodyWater_8 } from './script.js';
import { totalBodyWater_9 } from './script.js';
import { totalBodyWater_10 } from './script.js';
import { totalBodyWater_11 } from './script.js';
import { totalBodyWater_12 } from './script.js';
import { totalBodyWater_13 } from './script.js';
import { totalBodyWater_14 } from './script.js';
import { totalBodyWater_15 } from './script.js';
import { totalBodyWater_16 } from './script.js';
import { totalBodyWater_17 } from './script.js';
import { totalBodyWater_18 } from './script.js';
import { totalBodyWater_19 } from './script.js';
import { totalBodyWater_20 } from './script.js';
import { totalBodyWater_21 } from './script.js';
import { totalBodyWater_22 } from './script.js';
import { totalBodyWater_23 } from './script.js';
import { totalBodyWater_24 } from './script.js';

if (totalBodyWater_1.value >= 42 && totalBodyWater_1.value <= 49) {
  totalBodyWater_1.style.background = 'green';
} else if (totalBodyWater_1.value >= 49) {
...
if (totalBodyWater_2.value >= 42 && totalBodyWater_2.value <= 49) {
  totalBodyWater_2.style.background = 'green';
} else if (totalBodyWater_2.value >= 49) {
...
} else if (totalBodyWater_3.value >= 49) {
...
} else if (totalBodyWater_4.value >= 49) {
...
} else if (totalBodyWater_5.value >= 49) {
...
} else if (totalBodyWater_6.value >= 49) {
...
} else if (totalBodyWater_7.value >= 49) {
...
} else if (totalBodyWater_8.value >= 49) {
...
} else if (totalBodyWater_9.value >= 49) {
...
} else if (totalBodyWater_10.value >= 49) {
...
} else if (totalBodyWater_11.value >= 49) {
...
} else if (totalBodyWater_12.value >= 49) {
...
} else if (totalBodyWater_13.value >= 49) {
...
} else if (totalBodyWater_14.value >= 49) {
...
} else if (totalBodyWater_15.value >= 49) {
...
} else if (totalBodyWater_16.value >= 49) {
...
} else if (totalBodyWater_17.value >= 49) {
...
} else if (totalBodyWater_18.value >= 49) {
...
} else if (totalBodyWater_19.value >= 49) {
...
} else if (totalBodyWater_20.value >= 49) {
...
} else if (totalBodyWater_21.value >= 49) {
...
} else if (totalBodyWater_22.value >= 49) {
...
} else if (totalBodyWater_23.value >= 49) {
...
} else if (totalBodyWater_24.value >= 49) {
